...
<head>
    ...
    <style>
        ...
        #menu_img_1{position: fixed;left:0px;top:45%;width: 10%}
        #menu_img_2{position: fixed;left:0px;top:65%;width: 10%}
        /*search*/
        ...
        #search_img{width: 80%;z-index: 1000;border-radius: 20px;overflow: hidden;object-fit: cover;}
        #show_search{width: 100%;display: none;z-index: 1000;position:fixed;left:11%}
        #placeholder{font-size: 20px}
        input::-webkit-input-placeholder{color: white;font-size: 14px;font-weight:300;}
        #search input{width: 100%;height: 100%;border-radius: 18px;border:1px solid;outline:none;letter-spacing:1px;padding: 10px;font-size:16px}
        #search{position: absolute;top:0;width:77%;height:18px;left:11.5%;}
        #search_img{width: 40%;height: 70%;z-index: 1000;border-radius: 20px;margin-top: 40px;overflow: hidden;object-fit: cover;}
        #show_search{width: 80%;display: none;z-index: 1000;position:fixed;left: 35%}
        input::-webkit-input-placeholder {color: #ff3c54;font-size: 20px;background: #ffffff;}
    </style>
    <script>
            ...
            for(i=0;i<4;i++){
                ...
                switch (i) {
                    case 0:{
                        ...
                        new_arr[0]=get_outline_height(picture_number);
                    ...
                    case 2:{
                        var new_arr=new Array();
                        new_arr[0]=get_outline_height(picture_number);
                        list_height['list2']=new_arr;
                        break;
                    }
                    case 3:{
                        var new_arr=new Array();
                        new_arr[0]=get_outline_height(picture_number);
                        list_height['list3']=new_arr;
                        break;
                    }
                }
            }
...
<div id="menu">
  ...
  图
    ...
    <a href="rank.php" target="_blank"><img id="menu_img_1" src="img/ranking_list.png" alt="加载失败"/></a>
